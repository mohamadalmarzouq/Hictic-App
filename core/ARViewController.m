...
- (void)viewDidLoad {
    ...
    if ( [WTArchitectView isDeviceSupportedForRequiredFeatures:WTFeature_ImageTracking error:&deviceSupportError] ) {
        ...
        NSURL *absoluteURL = [NSURL URLWithString:[self url] relativeToURL:relativeURL];
        ...
        self.architectWorldNavigation = [self.architectView loadArchitectWorldFromURL:absoluteURL];
